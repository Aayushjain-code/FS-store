	...
	return (
		<div className="filter-container">
			...
			<span className="filter-sub-heading">
				...
				<select onChange={(e) => filterDispatch({ type: 'SORT_BY_PRICE_RANGE', payload: e.target.value })}>
			...
			<span className="filter-sub-heading">
				...
				<br />
				<label>
					<input type="checkbox" name="group1" onChange={() => filterDispatch({ type: 'ONLY_ITEMS_WITH_OFFER' })} checked={filterState.offerItems} /> <span>Item With Offers Only</span>
				</label>
			</span>
